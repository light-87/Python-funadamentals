...
# In this project, We will use our knowledge of Python dictionaries to create a database of medical records for patients.
...
# We notice that Vinay’s insurance cost was incorrectly inputted. Update the value associated with Vinay to 3325.0.
