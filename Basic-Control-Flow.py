...
# we will apply our knowledge of Python control flow to write code that gives people advice on how to lower their medical insurance costs.


# Function to analyzes an individual’s smoking status.
...
# Function to analyzes an individual’s BMI (body mass index).
